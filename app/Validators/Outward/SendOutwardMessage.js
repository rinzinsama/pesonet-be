...
class OutwardSendOutwardMessage {
  async authorize() {
  ...
  get messages() {
    return {
      ...
      "forSubmission.required": "(forSubmission) is required.",
      "forSubmission.array": "(forSubmission) must be an array.",
    };
  }
...
module.exports = OutwardSendOutwardMessage;
