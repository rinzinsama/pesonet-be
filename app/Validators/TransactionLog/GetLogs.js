...
class TransactionLogGetLogs {
  ...
  get rules() {
    return {
      referenceId: "required|string|orExists:inward,outward,reference_id",
  ...
  get messages() {
    return {
      ...
      "referenceId.orExists": "(referenceId) does not exists.",
...
module.exports = TransactionLogGetLogs;
